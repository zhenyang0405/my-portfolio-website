...
export default function Home() {
  ...
  const [textButtonColor, setTextButtonColor] = useState('white');
  ...
  useEffect(() => {
    if (dark === false) {
      ...
      setButtonColor('#64ffda');
      setTextButtonColor('#222');
    }
  }, [dark])
              ...
              <div className={styles.top_right}>
                <div className={styles.menu_container}>
                  <div className={styles.theme_option}>
                    {(dark) 
                      ? <Image src='/moon-white.png' alt='Moon' width={30} height={30} onClick={() => toggleTheme(false)} />
